...
BeatPicker.prototype = {
    dateInputNode: null,
    pickerNode: null,
    daysSimple: "S P A T K Pn Š".split(" "),
    daysFull: [],
    monthsSimple: "Sau Vas Kov Bal Geg Bir Lie Rugp Rugs Spa Lap Gruo".split(" "),
    monthsFull: "Sausis Vasaris Kovas Balandis Gegužė Birželis Liepa Rugpjūtis Rugsėjis Spalis Lapkritis Gruodis".split(" "),
    startDate: new Date,
